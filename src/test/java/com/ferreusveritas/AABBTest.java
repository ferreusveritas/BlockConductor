...
class AABBTest {
	...
	void testAABBIsPointInside() {
		...
		assertFalse(aabb.contains(new Vec3I(-1, 0, 0)));
		assertTrue(aabb.contains(new Vec3I(5, 5, 5)));
		assertTrue(aabb.contains(new Vec3I(0, 0, 0)));
		assertTrue(aabb.contains(new Vec3I(10, 10, 10)));
		assertFalse(aabb.contains(new Vec3I(11, 11, 11)));
	}
