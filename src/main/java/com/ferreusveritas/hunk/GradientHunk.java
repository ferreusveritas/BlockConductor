...
public class GradientHunk extends Hunk {
	...
	public GradientHunk(Scene scene) {
		this(scene, DEFAULT_MIN_Y, DEFAULT_MAX_Y);
	}
	
	public GradientHunk(Scene scene, double minY, double maxY) {
		super(scene);
		this.minY = minY;
		this.maxY = maxY;
	}
	
	public GradientHunk(Scene scene, JsonObj src) {
		super(scene, src);
