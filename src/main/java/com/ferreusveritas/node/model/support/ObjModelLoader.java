...
public class ObjModelLoader {
	...
	public static Optional<ObjModel> load(String path, String part) {
		try {
			InputStream stream = Storage.getInputStream(path);
			return load(stream, part);
		} catch (Exception e) {
	...
	public static Optional<ObjModel> load(InputStream stream, String part) {
		InputStreamReader reader = new InputStreamReader(stream);
		return load(reader, part);
	}
	
	public static Optional<ObjModel> load(Reader reader, String part) {
		ObjModelLoader loader = new ObjModelLoader(reader);
		ObjModel model = new ObjModel(loader.getFaces(part));
	...
	public List<FullFace> getFaces(String part) {
		O o = objects.get(part);
		if(o == null) {
