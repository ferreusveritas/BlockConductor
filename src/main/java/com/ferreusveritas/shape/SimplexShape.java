...
public class SimplexShape extends Shape {
	...
	private SimplexShape(Scene scene, double frequency, double lacunarity, double persistence, int octaves, int seed) {
		super(scene);
	...
	public SimplexShape(Scene scene, JsonObj src) {
		super(scene, src);
	...
	public static class Builder {
		...
		public SimplexShape build(Scene scene) {
			return new SimplexShape(scene, frequency, lacunarity, persistence, octaves, seed);
		}
