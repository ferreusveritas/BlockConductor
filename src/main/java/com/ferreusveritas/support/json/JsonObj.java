...
public class JsonObj implements Iterable<JsonObj> {
	...
	/**
	 * Returns a list if the provided property name is a list.
	 * Otherwise, returns an empty list.
	 *
	 * @param name The name of the property
	 * @return A list or an empty list
	 */
	public JsonObj getList(String name) {
		JsonObj obj = getObjInternal(name);
		if(obj.isList()) {
			return obj;
		}
		return JsonObj.newList();
	}
	
	/**
	 * Returns a map if the provided property name is a map.
	 * Otherwise, returns an empty map.
	 *
	 * @param name The name of the property
	 * @return A map or an empty map
	 */
	public JsonObj getMap(String name) {
		JsonObj obj = getObjInternal(name);
		if(obj.isMap()) {
			return obj;
		}
